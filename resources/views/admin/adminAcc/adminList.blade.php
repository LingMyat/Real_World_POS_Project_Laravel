    ...
    <div class="table-data__tool">
        <div class="table-data__tool-left">
            <div class="overview-wrap">
                <h2 class="title-1">Admin List -</h2><h5>( witout current acc )</h5>
            </div>
        </div>
    </div>
                        ...
                        <tr class="tr-shadow @if ($row->id === auth()->id()) d-none @endif">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <input class="row-id d-none" type="number" value="{{ $row->id }}">
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item user-btn" href="#">User</a></li>
                                    </ul>
                                </div>
                            </td>
                            <td>
                                <div  class="table-data-feature d-flex justify-content-start">
                                    <a href="{{ route('admin#delete',$row->id) }}" class="item mx-1" data-toggle="tooltip" data-placement="top" title="Delete">
...
@section('scriptSource')
    <script>
        $(document).ready(function(){
            ...
            let rowId = document.getElementsByClassName('row-id');
            let adminToUser = function(i){
                $request = {
                        'id' : rowId[i].value,
                        'role' : 'user' ,
                    }
